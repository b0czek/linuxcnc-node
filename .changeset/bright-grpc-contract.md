...
HAL protocol aligned with the exact 64-bit-capable domain value union through
the cutover, then retire the legacy TypeScript/N-API packages and Eden bridge.
